        ...
        service.sendRequest(for: .fullInfo(transferedData.id), params: ["Content-Type": "application/json"], headers: ["Authorization": "Client-ID 6PgiFLKinDxM6Ebz502_NRQ-X_Ay_txIRoF1mYysqb0"],  responseType: PhotoFullInfo.self) { info in
            ...
            DispatchQueue.main.async {
                ...
                if !tags.isEmpty {
                    ...
                    str.removeLast()
                    self.service.sendRequest(for: .related(tags), params: ["Content-Type": "application/json", "query": str], headers: ["Authorization": "Client-ID 6PgiFLKinDxM6Ebz502_NRQ-X_Ay_txIRoF1mYysqb0"],  responseType: PhotoRelatedInfo.self) { response in
                        var news: [News] = [transferedData]
                        response.results.forEach {
                            ...
                            news.append(News(id: id, title: title, thumbImageStringUrl: $0.urls.thumb, regularImageStringUrl: $0.urls.regular, recentness: dateString))
                        }
